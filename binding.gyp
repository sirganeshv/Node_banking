{
	"targets": [
		
		{
			...
			"sources": ["./src/C++/custom.hpp","./src/C++/Banking.cpp","./src/C++/WinTimer.h","./src/C++/dbconnector.h","src/C++/file_handler.h","src/C++/global.h","src/C++/timestamp.h","src/C++/type.h","src/C++/valid.h"],
			"include_dirs": [
